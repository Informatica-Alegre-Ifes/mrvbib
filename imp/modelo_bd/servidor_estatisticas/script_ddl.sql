...
BEGIN
	...
	DECLARE DADO_GPS_ENCONTRADO, DUMMY, DADO_IGNORADO INT;
	SET DADO_IGNORADO = 1;
	...
	IF DADO_GPS_ENCONTRADO > 0 THEN
		SET MENSAGEM_ERRO = CONCAT('TRG_DADO_GPS_INS - [DADO_CD_VEICULO] E [DADO_DT_CAPTURA] JÁ EXISTEM PARA: ', NEW.DADO_CD_VEICULO, ' E ', CAST(NEW.DADO_DT_CAPTURA AS CHAR), '.');
