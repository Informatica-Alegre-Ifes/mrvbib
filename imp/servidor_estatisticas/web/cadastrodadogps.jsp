...
<html>
	<head>
		<title>Cadastro de Dado GPS</title>
	</head>
	<body>
		<%
			try
			{
				...
				String orientacaoLongitude = request.getParameter("olo");
				...
				consulta.execute("INSERT INTO DADO_GPS (DADO_CD_MAC_DISPOSITIVO, DADO_VL_LATITUDE, DADO_SG_ORIENTACAO_LATITUDE, DADO_VL_LONGITUDE, DADO_SG_ORIENTACAO_LONGITUDE, DADO_VL_VELOCIDADE, DADO_DT_CAPTURA, DADO_DT_REGISTRO) VALUES ('" + dispositivo + "', " + latitude + ", '" + orientacaoLatitude + "', " + longitude + ", '" + orientacaoLongitude + "', " + velocidade + ", '" + formatoData.format(dataHora) + "', NOW());");
				conexao.close();
			}
